...
describe 'the Friday test :)' do
  ...
  it 'should show fizzbuzz without modulo' do 
    n = fizzbuzz_without_modulo(20)
    expect(n).to eq( [1, 2, "fizz", 4, "buzz", "fizz", 7, 8, "fizz", "buzz", 11, "fizz", 13, 14, "fizzbuzz", 16, 17, "fizz", 19, "buzz"])
  end 
end
